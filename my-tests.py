...
import numpy as np
from bt709 import to_rgb, to_yuv
...
img = img_as_float(imread('red-flower.png'))
imsave('red-flower-but-its-actually-bnw.png', to_yuv(img)[:, :, 0])
...
# im_with_dwm = rng_filter_yuv(median, im_with_dwm)
# im_with_dwm = rng_filter_yuv(median, im_with_dwm)
# imsave('red-flower-median.png', im_with_dwm)
# im_with_dwm = image.copy()
# im_with_dwm = rng_filter_yuv(erosion, im_with_dwm)
# im_with_dwm = rng_filter_yuv(erosion, im_with_dwm)
# imsave('red-flower-erosion.png', im_with_dwm)
# im_with_dwm = image.copy()
# im_with_dwm = rng_filter_yuv(dilatation, im_with_dwm)
# im_with_dwm = rng_filter_yuv(dilatation, im_with_dwm)
# im_with_dwm = rng_filter_yuv(dilatation, im_with_dwm)
# imsave('red-flower-dilatation.png', im_with_dwm)
# imshow(im_with_dwm)
# plt.show()
